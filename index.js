...
上記に続けて、以下の内容を**やさしい語り口＆女性向けのトーン**で、**800文字以内**で書いてください。
構成は以下の通りにしてください：

1. 共感から始める（ユーザーの性格への寄り添い）
2. 3つの診断結果から見える「今のあなた」と「本来の性質」のズレをやさしく指摘
3. そのズレをどのように補い、活かせばよいかのアドバイス
4. 最後に、白くまらしい温かく前向きなメッセージでしめくくる

語尾は「〜だよ」「〜かもね」「〜してみようね」など親しみのある話し方にしてください。
見やすさのため、1〜2文ごとに適度に改行を入れてください。
`;
